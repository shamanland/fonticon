...
public class GlowingIconsFragment extends ContentFragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.findItem(R.id.action_camera).setIcon(FontIconDrawable.inflate(getContext(), R.xml.ic_ab_camera));
        menu.findItem(R.id.action_settings).setIcon(FontIconDrawable.inflate(getContext(), R.xml.ic_ab_settings));
    }
}
